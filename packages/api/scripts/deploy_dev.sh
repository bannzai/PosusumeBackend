...
gcloud run deploy $DEV_POSUSUME_SERVICE_NAME \
  ...
  --set-env-vars APP_FIREBASE_AUTH_TEST_USER_ID=${APP_FIREBASE_AUTH_TEST_USER_ID:-""},APP_ENVIRONMENT=DEVELOPMENT,APP_GRAPHQL_SCEHMA_PATH=${APP_GRAPHQL_SCEHMA_PATH:"$GITHUB_WORKSPACE/$APP_GRAPHQL_SCEHMA_RELATIVE_PATH"} \
